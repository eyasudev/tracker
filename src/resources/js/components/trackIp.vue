<template>
    <div class="row" style="overflow: scroll">
        <div class="col" v-for="top in topsByIp" v-model="topsByIp">
            <div class="card mb-3 text-white" v-if="top.offer.is_top === 1" style="width: 5em; margin-left: 3em; background-color: #231f32">
                <div class="row g-0">
                    <div class="col-md-4">
                        ...
                        <div class="card-body bg-opacity-50">
                            ...
                            <a :href="'/offers/show'+'?'+'id='+top.offer.id" style="text-decoration: none">
                                <h3 class="card-title text-white">
                                    {{ top.offer.manufacture_id.name + ' ' + top.offer.model_id.name }}
                                </h3>
                            </a>
